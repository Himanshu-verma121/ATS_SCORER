...
RESUME_SYSTEM_PROMPT = (
    """
        You are an expert resume parser. Ectract information form the resume and 
        return ONLY a valid JSON object. No explanations, no markdown, no text, no comments, no extra information.
    """
)

RESUME_USER_PROMPT = """Extract the following information from the resume and return as JSON:
{{
