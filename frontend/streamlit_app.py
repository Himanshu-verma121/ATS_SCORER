...
if (
    ...
    if "error" in result:
        ...
        print("Token exists:", bool(st.session_state.access_token), flush=True)
        print("Token length:", len(st.session_state.access_token or ""), flush=True)
        print("User ID exists:", bool(st.session_state.user_id), flush=True)
        st.rerun()
...
with st.sidebar:
    ...
    if st.session_state.access_token:
        ...
        # Signed-out state:  sign-in vs sign-up + Google OAuth button.
